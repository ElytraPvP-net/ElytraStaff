package net.elytrapvp.elytrastaff.commands;

import net.elytrapvp.elytrastaff.ElytraStaff;
import net.elytrapvp.elytrastaff.utils.chat.ChatUtils;
...
public abstract class AbstractCommand implements CommandExecutor {
    ...
    private static ElytraStaff plugin;
     ...
     * @param pl Plugin.
     */
    public static void registerCommands(ElytraStaff pl) {
        plugin = pl;
